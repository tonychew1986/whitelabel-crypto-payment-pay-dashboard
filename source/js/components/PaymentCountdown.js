...
export default class PaymentCountdown extends React.Component {
  ...
  render() {
    ...
    if(this.props.paymentCompleted){
      ...
      countdownTimerPaidDisplay = (
        <div className={cx('countdownTimerPre')}>
          <div className={cx('countdownTimerEntry')}>
            <div className={cx('paymentHighlightTitle')}>
              Payment Countdown
            </div>
            <div className={cx('num', 'paymentHighlight')}>
              <Countdown
                ...
                renderer={props => <span>{props.hours}:{props.minutes}:{props.seconds}</span>}
          ...
          <div className={cx('countdownTimerEntry')}>
            <div>
              ...
              payment before the countdown expires
            </div>
          </div>
          <div className={cx('countdownTimerEntry')}>
            <div>
              Please do not refresh the screen while payment is being processed
            </div>
          </div>
        </div>
      )
